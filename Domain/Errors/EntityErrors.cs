...
public static class EntityErrors
{
    ...
    public static Error NotFound<T>(string entityName, Guid guid, T primaryKeySecondArgument) => new Error($"{entityName}.NotFound", $"The {entityName} with id {guid} and {primaryKeySecondArgument} was not found");
